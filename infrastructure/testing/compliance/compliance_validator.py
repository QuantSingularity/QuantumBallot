...
class ComplianceValidator:
    ...
    def validate_all(self) -> Dict[str, Any]:
        ...
        rules_by_level: Dict[ComplianceLevel, List[ComplianceRule]] = {}
    ...
    def _check_default_passwords(self) -> ComplianceResult:
        ...
        try:
            ...
            for db in db_instances:
                ...
                if param_groups and "default." in param_groups[0].get(
    ...
    def _check_stored_data_protection(self) -> ComplianceResult:
        ...
        try:
            ...
            db_instances = rds.describe_db_instances()["DBInstances"]
            unencrypted_dbs = sum(
                1 for db in db_instances if not db.get("StorageEncrypted", False)
            )
    ...
    def _check_transmission_encryption(self) -> ComplianceResult:
        ...
        result = self._check_data_transmission()
        result.rule_id = "PCI-DSS-4"
        return result
    ...
    def _check_vulnerability_management(self) -> ComplianceResult:
        ...
        evidence: Dict[str, Any] = {
            "vulnerability_scanning": "Manual review required",
            "patch_management": "Manual review required",
        }
