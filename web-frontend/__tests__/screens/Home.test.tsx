...
describe("Home Component", () => {
  ...
  it("renders the description text", () => {
    ...
    expect(
      screen.getByText(/secure, transparent, and efficient/i),
    ).toBeInTheDocument();
  });
  ...
  it("renders navigation buttons", () => {
    ...
    expect(
      screen.getByRole("button", { name: /View Candidates/i }),
    ).toBeInTheDocument();
    expect(
  ...
  it("navigation buttons are clickable", () => {
    ...
    const viewCandidatesBtn = screen.getByRole("button", {
      name: /View Candidates/i,
    });
