  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsxs(DialogHeader, {
          children: [
            _jsx(DialogTitle, { children: "Voter verification" }),
            _jsx(DialogDescription, { children: "Scan the QR Code." }),
          ],
        }),
        _jsx("div", {
          className: "flex justify-center items-center h-full",
          children: _jsx("img", { src: qrCodeURL, className: "w-64 h-64" }),
        }),
        _jsx(DialogFooter, { className: "flex justify-center items-center" }),
      ],
    }),
  });
}
