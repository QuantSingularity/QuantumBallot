        ...
        children: [
          ...
          _jsx(FormField, {
            ...
            render: ({ field }) =>
              _jsxs(FormItem, {
                children: [
                  _jsx(FormLabel, { children: "Electoral Number" }),
                  _jsx(FormControl, {
                    children: _jsx(Input, {
          ...
          _jsx(FormField, {
            ...
            render: ({ field }) =>
              _jsxs(FormItem, {
                children: [
                  _jsx(FormLabel, { children: "E-mail" }),
                  _jsx(FormControl, {
                    children: _jsx(Input, { placeholder: "E-mail", ...field }),
                  }),
                  _jsx(FormMessage, {}),
                ],
              }),
          ...
          _jsx(FormField, {
            ...
            render: ({ field }) =>
              _jsxs(FormItem, {
                children: [
                  _jsx(FormLabel, { children: "Address" }),
                  _jsx(FormControl, {
                    children: _jsx(Input, { placeholder: "Address", ...field }),
                  }),
                  _jsx(FormMessage, {}),
                ],
              }),
          ...
          _jsx(FormField, {
            ...
            render: ({ field }) =>
              _jsxs(FormItem, {
                children: [
                  _jsx(FormLabel, { children: "Province" }),
                  _jsx(FormControl, {
                    children: _jsxs(Select, {
                      ...
                      children: [
                        ...
                        _jsx(SelectContent, {
                          children: provinces.map((province, index) =>
                            _jsx(
                              SelectItem,
...
export const EditCitizenModal = ({
  ...
  return _jsx(Dialog, {
    ...
    children: _jsxs(DialogContent, {
      ...
      children: [
        _jsx(DialogHeader, {
          children: _jsx(DialogTitle, { children: "Edit Citizen" }),
        }),
        _jsx(CitizenForm, {
