...
export const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (typeof password === "string")
        return _jsxs("span", {
          children: [password.substring(0, "0xabcdef123456789".length), "..."],
        });
      else return "";
    },
  },
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (typeof refreshToken === "string")
        return _jsxs("span", {
          children: [
            refreshToken.substring(0, "rerewrwererxabcdef123456789".length),
            "...",
          ],
        });
      else return "";
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const user = row.original;
      return _jsx(_Fragment, {
        children: _jsx(CustomDropMenuUser, { user: user }),
      });
    },
  },
];
