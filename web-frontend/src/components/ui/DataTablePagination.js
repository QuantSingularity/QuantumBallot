            ...
            children: [
              ...
              _jsxs(Select, {
                ...
                children: [
                  ...
                  _jsx(SelectContent, {
                    side: "top",
                    children: [2, 3, 4, 5, 8, 10, 20, 30, 40, 50, 100].map(
                      (pageSize) =>
                        _jsx(
                          SelectItem,
            ...
            children: [
              _jsxs(Button, {
                ...
                children: [
                  ...
                  _jsx(DoubleArrowLeftIcon, { className: "h-4 w-4" }),
                ],
              }),
              _jsxs(Button, {
                variant: "outline",
                ...
                children: [
                  ...
                  _jsx(ChevronLeftIcon, { className: "h-4 w-4" }),
                ],
              }),
              _jsxs(Button, {
                variant: "outline",
                ...
                children: [
                  ...
                  _jsx(ChevronRightIcon, { className: "h-4 w-4" }),
                ],
              }),
              _jsxs(Button, {
                variant: "outline",
