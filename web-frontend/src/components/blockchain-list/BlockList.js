...
const middleItem = (id, hashBlock, blockSize) => {
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsx("div", {
        children: _jsx(Link, {
          to: `/blockchain/block-details/${hashBlock}`,
          children: _jsxs("span", {
            className:
              "font-inria-sans text-sm text-gray-400 flex justify-center relative bottom-0",
...
const CardItem = ({ id, hashBlock, index, len, blockSize }) => {
  ...
  return _jsx(
    "div",
    {
      ...
      children: _jsxs("div", {
        className: "flex flex-row items-center bg-yellow- h-full",
        children: [
          leftItem(),
...
export default function BlockList() {
  ...
  return _jsx("div", {
    ...
    children: _jsx("ul", {
      ...
      children: data
        .concat(getData(data.length + 1, 100))
        .flat()
        .map((item, index) =>
          _jsx(
            "li",
