  ...
  const otherCandidates = (item) => {
    return _jsxs(
      "div",
      {
        ...
        children: [
          _jsxs("div", {
            className: "flex flex-col bg-white relative h-max",
            children: [
              _jsx("div", {
                className: "p-3",
                style: {
              ...
              _jsx("div", {
                ...
                children: _jsx("img", {
                  src: BottomBackgroundCandidateBlack,
          ...
          _jsxs("div", {
            className: "flex flex-row mt-0.5",
            style: { backgroundColor: "#515151" },
            children: [
              _jsx("div", {
                className: "flex items-center ml-6 bg-white p-2",
                children: _jsxs("span", {
                  className: "font-bold justify-center items-center",
                  style: { color: "#515151", fontSize: "1.3rem" },
                  children: [item.percentage, "%"],
                }),
              }),
              _jsxs("div", {
                className: "ml-2.5 flex flex-col justify-start",
                children: [
                  _jsx("span", {
                    className: "font-bold",
                    style: { fontSize: "1rem", color: "#FBFAFA" },
                    children: item.candidate,
                  }),
                  _jsx("span", {
                    className: "font-bold justify-start",
                    style: { fontSize: "0.6rem", color: "#FBFAFA" },
                    children: item.numVotes,
                  }),
                ],
              }),
            ],
    ...
    children: [
      _jsxs("div", {
        ...
        children: [
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("div", {
                        children: _jsx("img", {
                          src: BottomBackgroundCandidateRed,
                          alt: "BottomBackground",
                        }),
                      }),
                      _jsx("img", {
                  ...
                  _jsxs("div", {
                    className: "flex flex-row mt-0.5",
                    style: { backgroundColor: "#DF2E2D" },
                    children: [
                      _jsx("div", {
                        className: "flex items-center ml-6 bg-white p-2",
                        children: _jsxs("span", {
                          className: "font-bold justify-center items-center",
                          style: { color: "#CE2524", fontSize: "1.5rem" },
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("span", {
                            className: "font-bold",
                            style: { fontSize: "1.6rem", color: "#FBFAFA" },
                            children: data[0].candidate,
                          }),
                          _jsx("span", {
                            className: "font-bold justify-start",
                            style: { fontSize: "1.2rem", color: "#FBFAFA" },
                            children: data[0].numVotes,
                          }),
                        ],
                      }),
                    ],
                ...
                children: [
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsx("div", {
                        children: _jsx("img", {
                          src: BottomBackgroundCandidateYellow,
                          alt: "BottomBackground",
                        }),
                      }),
                      _jsx("img", {
                  ...
                  _jsxs("div", {
                    className: "flex flex-row mt-0.5",
                    style: { backgroundColor: "#F4E16C" },
                    children: [
                      _jsx("div", {
                        className: "flex items-center ml-6 bg-white p-2",
                        children: _jsxs("span", {
                          className: "font-bold justify-center items-center",
                          style: { color: "#E9D766", fontSize: "1.5rem" },
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("span", {
                            className: "font-bold",
                            style: { fontSize: "1.6rem", color: "#FBFAFA" },
                            children: data[1].candidate,
                          }),
                          _jsx("span", {
                            className: "font-bold justify-start",
                            style: { fontSize: "1.2rem", color: "#FBFAFA" },
                            children: data[1].numVotes,
                          }),
                        ],
                      }),
                    ],
          ...
          _jsxs("div", {
            className: "flex flex-row items-center justify-center p-2 gap-5",
            style: { backgroundColor: "#515151" },
            children: [
              _jsx("img", {
                className: "flex",
                src: bottomCountryBackground,
                alt: "Background",
                width: "30%",
                height: "40%",
              }),
              _jsxs("span", {
                className:
                  "font-inria-sans font-bold text-gray-500 justify-center items-center",
                style: { fontSize: "1rem", color: "#AFAFAF" },
                children: [
                  "DIFFERENCE ",
                  Number((data[0].percentage - data[1].percentage).toFixed(2)),
                  "%",
                ],
              }),
              _jsx("img", {
      ...
      _jsx("div", {
        children: _jsx("div", {
          ...
          children: dataOther.map((item) => otherCandidates(item)),
        }),
      }),
    ],
  });
