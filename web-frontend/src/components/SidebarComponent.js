...
function SideBarComponent() {
  ...
  return _jsx("aside", {
    ...
    children: _jsxs("div", {
      className:
        "gap-5 flex flex-col h-screen px-3 py-2 rounded bg-white dark:bg-gray-800",
      children: [
        _jsx("div", {
          style: {
            display: "flex",
        ...
        _jsxs("div", {
          children: [
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(HiChartPie, { className: iconStyle }),
                _jsx("span", { className: textTyle, children: "Dashboard" }),
              ],
            }),
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(HiSpeakerphone, { className: iconStyle }),
                _jsx("span", {
                  className: textTyle,
                  children: "Announce Election",
                }),
              ],
            }),
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(FaUsers, { className: iconStyle }),
                _jsx("span", { className: textTyle, children: "Candidates" }),
              ],
            }),
            _jsxs(Link, {
              to: "voters",
              className: linkStyle,
              children: [
                _jsx(BsClipboardData, { className: iconStyle }),
                _jsx("span", { className: textTyle, children: "Voters" }),
              ],
            }),
            _jsxs(Link, {
              to: "population-data",
              className: linkStyle,
              children: [
                _jsx(VscRepoPull, { className: iconStyle }),
                _jsx("span", {
                  className: textTyle,
            ...
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(MdOutlineOutput, { className: iconStyle }),
                _jsx("span", {
                  className: textTyle,
            ...
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(GiPublicSpeaker, { className: iconStyle }),
                _jsx("span", {
                  className: textTyle,
            ...
            _jsxs(Link, {
              ...
              className: linkStyle,
              children: [
                _jsx(SiHiveBlockchain, { className: iconStyle }),
                _jsx("span", { className: textTyle, children: "Blockchain" }),
              ],
            }),
        ...
        _jsxs("div", {
          className:
            " items-center h-svh flex flex-row justify-between h-500 mr-4 align-center ",
          children: [
            _jsxs("div", {
              className: "flex flex-row h-max items-center gap-2 h-500",
              children: [
                _jsx(FaMoon, { className: iconStyle }),
                _jsx("span", { className: "mt-1", children: "Dark mode" }),
              ],
            }),
            _jsx("div", {
        ...
        _jsx("div", {
          className: "flex flex-max flex-col items-center",
          children: _jsx("img", { src: BlockchainIcon, width: 150 }),
        }),
        _jsx("div", {
                ...
                children: [
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      ...
                      _jsxs("div", {
                        className: "flex flex-col bg-purple-0 gap-0",
                        children: [
                          _jsx("div", {
                            className: " bg-slate-0",
                            children: _jsx("span", {
                              children: authState.name ?? "Unkown user",
                            }),
                          }),
                          _jsx("div", {
                            className: " bg-blue-0",
              ...
              _jsxs("div", {
                ...
                children: [
                  _jsxs("a", {
                    ...
                    children: [_jsx(BiLogOutCircle, {}), "Log out"],
                  }),
                  _jsx(Link, {
                    className: linkStyle,
                    to: "edit-account",
