          ...
          let newDataCandidates = results.candidatesResult.map(
            (x: any, index: number) => {
              ...
              return {
                ...
                candidatePhoto: imageList
                  ? (imageList[candidateName] ?? "")
                  : "",
        ...
        <div className="flex flex-col gap-3 col-span-1">
            ...
            <div className="pt-2">
              {dataResults?.totalVotesReceived && (
                <span className="text-gray-400">
                  {dataResults?.totalVotesReceived} Votes
                </span>
              )}
            </div>
          </div>
          ...
          <div className="bg-white flex flex-row gap-2 rounded-xl p-4 justify-between">
            ...
            <div className="flex flex-col justify-center items-center">
              ...
              {dataResults?.totalCandidates && (
                <span className="text-xl text-gray-400">
                  {dataResults?.candidatesResult.length}
                </span>
              )}
            </div>
          </div>
            ...
            <div className="grid grid-row-2 gap-2">
              <div className="flex flex-col">
                ...
                {dataResults.averageTimePerVote && (
                  <span className="font-inria-sans text-sm text-gray-400">
                    {Number(dataResults.averageTimePerVote.toFixed(2))} min /
                    vote
                  </span>
                )}
              </div>
              ...
              <div className="flex flex-col">
                ...
                {dataResults.averageVotePerProvince && (
                  <span className="font-inria-sans text-sm text-gray-400">
                    {Number(dataResults.averageVotePerProvince.toFixed(2))}{" "}
                    votes / prov.
                  </span>
                )}
              </div>
          ...
          <div className="h-max">
            <div className="grid grid-cols-5 gap-2">
              <div className="col-span-2 bg-white rounded-xl p-5">
                <div className="flex flex-col ">
                  <span className="font-inria-sans text-xl text-gray-400">
                    Daily increment in vote
                  </span>
                  <span className="font-inria-sans text-sm text-gray-300">
                    Last day x Today
                  </span>
                </div>
                <div>
