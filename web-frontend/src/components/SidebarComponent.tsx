...
function SideBarComponent() {
  ...
  return (
    <aside
      className="flex flex-col left-0 top-0 w-60 h-screen fixed transition-transform sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div className="gap-5 flex flex-col h-screen px-3 py-2 rounded bg-white dark:bg-gray-800">
        ...
        >
          <span className="text-2xl font-bold text-gray-500 uppercase tracking-wider">
            ELECTION 2027
          </span>
        </div>
        ...
        <div className="flex h-screen flex-col justify-end">
          <div className="flex flex-col justify-end gap-2">
            <div className="flex flex-col gap-1">
              <span className="justify-start">Profile</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col bg-purple-0 gap-0">
                  <div className=" bg-slate-0">
                    <span>{authState.name ?? "Unkown user"}</span>
                  </div>
