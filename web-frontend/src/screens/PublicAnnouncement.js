...
function PublicAnnouncement() {
  ...
  const handleClick = () => {
    ...
    setInterval(() => {
      if (counter < 100) {
        setCounter((x) =>
          Math.min(x + Math.floor(Math.random() * 50 + 5), 100),
        );
      } else {
        return;
      }
    ...
    return _jsxs(AlertDialog, {
      children: [
        _jsx(AlertDialogTrigger, {
          children: _jsx("div", {
            className:
              "flex items-center bg-gray-200 p-2 pl-3 pr-3 rounded-sm hover:bg-gray-300",
            children: _jsx("div", {
              children: _jsx(GiSoundWaves, { color: "#6B7280" }),
            }),
          }),
        }),
                ...
                children: [
                  ...
                  _jsx("div", {
                    ...
                    children: _jsx(AlertDialogAction, {
                      ...
                      children: "Generate and Play New Speech",
                    }),
                  }),
                ],
              }),
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("span", {
        className: "font-inria-sans text-2xl text-gray-400",
        children: "Election Public Announcement",
      }),
      _jsxs("div", {
        className:
          "md:items-center md:gap-2 md:flex-col w-full bg-red h-screen",
        children: [
          _jsxs("div", {
            className: "flex justify-between mb-1",
            children: [
              _jsx("span", {
                className: "font-inria-sans text-xl text-gray-400",
                children: "2027 Election Results",
              }),
              _jsxs("div", {
                className: "flex gap-10 items-center",
                children: [
                  _jsx(SoundButton, { type: "on" }),
                  _jsx(SoundButton, { type: "off" }),
          ...
          _jsxs("div", {
            className:
              "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 xl:grid-cols-7 2xl:grid-cols-7 gap-3",
            children: [
              _jsxs("div", {
                className: "col-span-3 flex flex-col gap-5 md:flex-col ",
                children: [
                  _jsxs("div", {
                    className: "flex flex-col md:gap-2 w-full bg-red gap-2 ",
                    children: [
                      _jsxs("div", {
                        className:
                          "flex flex-row gap-2 py-1 sm:flex-row md:flex-row",
                        children: [
                          _jsx(Button, {
                            className: "max-w-lg ",
                          ...
                          _jsx("button", {
                            ...
                            style: {
                              ...
                              transition:
                                "transform 0.2s ease, box-shadow 0.2s ease", // Added transition for hover effect
                            },
                            children: clicked
                              ? "Processing..."
                              : "Process Results",
                      ...
                      data && _jsx(TableElectionResultsPublic, { data: data }),
                    ],
                  }),
                  _jsxs("div", {
                    ...
                    children: [
                      _jsxs("div", {
                        className:
                          "flex flex-col gap-1 sm:gap-2 md:gap-3 lg:gap-4 items-center justify-center",
                        children: [
                          _jsx("span", {
                            className:
                              "font-inria-sans text-base sm:text-lg md:text-xl lg:text-2xl text-gray-500",
                            children: "Progress",
                          }),
                          _jsxs("span", {
                            className:
                              "font-bold font-inria-sans text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-600",
                            children: [counter, "%"],
                          }),
                        ],
                      }),
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  !data && _jsx("span", { children: "Loading ..." }),
                ],
              }),
            ],
          }),
