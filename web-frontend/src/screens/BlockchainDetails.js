...
function BlockchainDetails() {
  ...
  const URI =
    ...
    `/api/blockchain/block-detail/${blockHash}`;
  ...
  const blockItem = () => {
    const maxSize = 300;
    const perc =
      blockSize !== null ? Math.min((blockSize * 100) / maxSize, 100) : 100;
    return _jsx("div", {
      style: {
        width: "160px",
        height: "100%",
  ...
  return _jsxs("div", {
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("span", {
            className: "font-inria-sans text-md text-gray-400",
            children: "Blockchain",
          }),
          _jsx(BlockList, {}),
        ],
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            className:
              "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-5 pl-3",
            children: [
              _jsxs("div", {
                ...
                children: [
                      ...
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("div", {
                            children: _jsx("span", {
                              className:
                                "font-inria-sans text-sm text-gray-400",
                              children:
                                "Broadcasted on 06 Apr 2027 12:19:08 GMT+2",
                            }),
                          }),
                          _jsx("div", {
                            className: "flex flex-col gap-1",
                              ...
                              children: [
                                  ...
                                  children: [
                                    ...
                                    _jsxs("div", {
                                      ...
                                      children: [
                                        _jsx("span", {
                                          className: "",
                                          children: blockHeader?.blockHash,
                                        }),
                                        _jsx(BlockCopyButton, {
                                ...
                                _jsxs("div", {
                                  ...
                                  children: [
                                    _jsx("span", {
                                      className:
                                        "font-inria-sans text-sm text-gray-400",
                                      children: "Previous BlockHash:",
                                    }),
                                    _jsx("span", {
                                      className: "",
                                      children: blockHeader?.previousBlockHash,
                                    }),
                                  ],
                                }),
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsxs("div", {
                                      ...
                                      children: [
                                        _jsx("span", {
                                          className: "",
                                          children: blockHeader?.merkleRoot,
                                        }),
                                        _jsx(BlockCopyButton, {
                                          event: "copy_chunk_code",
                                ...
                                _jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    _jsx("span", {
                                      className: "",
                                      children: blockHeader?.difficultyTarget,
                                    }),
                                  ],
                                }),
                                _jsxs("div", {
                  ...
                  _jsxs("div", {
                    children: [
                      ...
                      _jsx(TableTransactionsBlockDetails, { detail: data }),
                    ],
                  }),
                ],
              }),
              _jsxs("div", {
                ...
                children: [
                  _jsx("span", {
                    className:
                      "font-bold font-inria-sans text-lg text-gray-400",
                    children: "JSON",
                  }),
                  _jsx("div", {
                    children: _jsxs(Tabs, {
                      ...
                      children: [
                        ...
                        _jsx(TabsContent, {
                          value: "pretty",
                          children: _jsx(JsonEditor, { data: data }),
                        }),
                        _jsx(TabsContent, {
                          value: "raw",
                          children: _jsx(EditorRaw, { data: data }),
                        }),
                      ],
                    }),
                  }),
