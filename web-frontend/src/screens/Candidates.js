    ...
    axios
      .get(
        "http://" +
          ...
          "/api/blockchain/deploy-candidates",
      )
      .then((response) => {
        const candidates = response.data.candidates;
        if (candidates) {
  ...
  const onPressDeleteFromBlockchain = () => {
    axios
      .get(
        "http://" +
          GLOBAL_VARIABLES.LOCALHOST +
          "/api/committee/clear-candidates",
      )
      .then((response) => {
        const candidates = response.data.candidates;
        if (candidates) {
            ...
            _jsxs(AlertDialogFooter, {
              children: [
                ...
                _jsx(AlertDialogAction, {
                  onClick: onPressDeployBlockchain,
                  children: "Continue",
                }),
              ],
            }),
    ...
    return _jsxs(AlertDialog, {
      children: [
        _jsx(AlertDialogTrigger, {
          children: _jsx("span", {
            className:
              "max-w-lg inline-block text-md bg-red-900 text-white px-4 py-2 rounded-md cursor-pointer hover:bg-gray-800",
            children: "Delete from Blockchain",
          }),
        }),
        _jsxs(AlertDialogContent, {
          children: [
            ...
            _jsxs(AlertDialogFooter, {
              children: [
                _jsx(AlertDialogCancel, { children: "Cancel" }),
                _jsx(AlertDialogAction, {
                  onClick: onPressDeleteFromBlockchain,
                  children: "Continue",
                }),
              ],
            }),
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
              ...
              _jsxs("div", {
                ...
                children: [
                  ...
                  _jsx(Button, {
                    ...
                    children: "Load Candidates",
                  }),
                  _jsx(Button, {
                    className: "max-w-lg md:w-auto",
                    onClick: onPressLoadCandidatesNotDeployed,
                    children: "Load Candidates [Not Deployed]",
                  }),
                ],
              }),
              openDialogDeploy(),
          ...
          _jsx(TableCandidates, { data: data, setData: setData, toast: toast }),
        ],
      }),
    ],
  });
