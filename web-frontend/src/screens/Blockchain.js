          ...
          if (res) {
            if (res.length > 0) {
              ...
              toast({
                title: "Feedback",
                description:
                  "Success, however, there was no block to mine unfortunately ...",
              });
            }
          } else {
            toast({
    ...
    children: [
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx("div", {
            children: _jsxs("div", {
              className: "flex flex-col sm:col-span-2 gap-2",
              children: [
                _jsxs("div", {
                  className: "flex flex-col",
                  children: [
                      ...
                      children: [
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            ...
                            _jsx(Button, {
                              className:
                                "max-w-xs inline-block text-xs bg-green-900 text-white px-2 py-1 m-1 rounded-md cursor-pointer hover:bg-gray-800",
