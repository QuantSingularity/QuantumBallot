...
function AnnounceElection() {
  ...
  const onPressDeployAnnouncementBlockchain = async () => {
    if (formValidation()) {
      ...
      const URL =
        ...
        "/api/committee/deploy-announcement";
      const body = {
    ...
    axios
      ...
      .then((response) => {
        ...
        receivers.forEach((element) => {
          ...
          axios
            .post(
              `http://${GLOBAL_VARIABLES.LOCALHOST}/api/committee/send-email`,
              options,
            )
            .then((response) => {
    ...
    return _jsxs(AlertDialog, {
      children: [
        _jsx(AlertDialogTrigger, {
          children: _jsx("span", {
            className:
              "max-w-lg inline-block text-md bg-green-900 text-white px-4 py-2 rounded-md cursor-pointer hover:bg-gray-800",
            children: "Deploy to Blockchain",
          }),
        }),
            ...
            _jsxs(AlertDialogFooter, {
              children: [
                ...
                _jsx(AlertDialogAction, {
                  onClick: onPressDeployAnnouncementBlockchain,
                  children: "Continue",
                }),
              ],
            }),
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("span", {
        className: "font-inria-sans text-2xl text-gray-600",
      ...
      _jsx("div", {
        ...
        children: _jsx("div", {
          ...
          children: _jsxs("div", {
            className:
              "flex flex-col w-full flex-grow items-center justify-center p-0",
            children: [
              _jsxs("div", {
                className: "flex flex-1 gap-2 justify-between py-4 w-[400px]",
                children: [
                  _jsx(Button, {
                    className: "max-w-lg",
                    onClick: onPressLoadAnnouncement,
                    children: "Load Announcement",
                  }),
                  _jsx(Button, {
                    className: "max-w-lg",
                    onClick: onPressNotifyVoters,
                    children: "Notify all voters by e-mail",
                  }),
                ],
              }),
              _jsx("form", {
                children: _jsxs(Card, {
                  ...
                  children: [
                    _jsxs(CardHeader, {
                      children: [
                        _jsx(CardTitle, { children: "Announcement" }),
                        _jsx(CardDescription, {
                          children: "Set the election details here.",
                        }),
                      ],
                    }),
                    _jsxs(CardContent, {
                      ...
                      children: [
                        ...
                        errors.numVoters
                          ? _jsx("div", {
                              style: styles.errorText,
                              children: errors.numVoters,
                            })
                          : null,
                        _jsxs("div", {
                          className: "space-y-1",
                          children: [
                            _jsx(Label, { children: "Results date" }),
                            _jsx(DatePicker, {
                              date: dateResults,
                              setDate: setDateResults,
                            }),
                          ],
                        }),
                        errors.resultDate
                        ...
                        _jsxs("div", {
                          className: "space-y-1",
                          children: [
                            _jsx(Label, { children: "Election duration" }),
                            _jsx(DatePickerWithRange, {}),
                          ],
                        }),
                        errors.electionDuration
                          ? _jsx("div", {
                              style: styles.errorText,
                              children: errors.electionDuration,
                            })
                          : null,
                      ],
                    }),
