      ...
      children: [
        _jsxs("div", {
          ...
          children: [
              ...
              children: [
                ...
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    dataResults?.totalVotesReceived &&
                      _jsxs("span", {
                ...
                _jsx("div", {
                  ...
                  children:
                    ...
                    _jsxs("span", {
                      ...
                      children: [dataResults?.totalVotesReceived, " Votes"],
                    }),
                }),
              ],
            }),
            _jsxs("div", {
              className:
                "bg-white flex flex-row gap-2 rounded-xl p-4 justify-between",
              children: [
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    dataResults?.totalCandidates &&
                      _jsxs("span", {
                        className: "text-xl text-gray-400",
                        children: [dataResults?.expectedTotalVotes, " M"],
                      }),
                  ],
                }),
                _jsxs("div", {
                  ...
                  children: [
                    ...
                    dataResults?.totalCandidates &&
                      _jsx("span", {
                        className: "text-xl text-gray-400",
                        children: dataResults?.candidatesResult.length,
                      }),
                  ],
                }),
              ],
            ...
            _jsxs("div", {
              className: "bg-whtie flex flex-col bg-white gap-2 rounded-xl p-4",
              children: [
                _jsx("span", {
                  className: "font-inria-sans text-xl text-gray-400",
                  children: "Top Party",
            ...
            _jsxs("div", {
              className: "bg-white flex flex-col gap-5 rounded-xl p-4",
              children: [
                _jsx("span", {
                  className: "font-inria-sans text-xl text-gray-400",
                  children: "Top votes by province",
                }),
                _jsx("div", {
                      ...
                      _jsxs(
                        "div",
                        {
                          ...
                          children: [
                            _jsx("span", {
                              className:
                                "flex justify-end col-span-2 font-inria-sans text-sm",
                              children: provinceData.province,
                            }),
                            _jsx("div", {
                              className: "col-span-3",
                              children: _jsx(ThemeProvider, {
                                theme: themeLinearProgressBar,
                                children: _jsx(Stack, {
                                  sx: { width: "100%" },
                                  spacing: 2,
            ...
            _jsxs("div", {
              className:
                "grid grid-cols-2 bg-white gap-2 rounded-xl p-4 justify-between",
              children: [
                _jsxs("div", {
                  className: "grid grid-row-2 gap-2",
                  children: [
                    _jsxs("div", {
                      ...
                      children: [
                        ...
                        dataResults.averageTimePerVote &&
                          _jsxs("span", {
                            className: "font-inria-sans text-sm text-gray-400",
                            children: [
                              Number(dataResults.averageTimePerVote.toFixed(2)),
                              " min / vote",
                            ],
                          }),
                      ],
                      ...
                      children: [
                        ...
                        dataResults.averageVotePerProvince &&
                          _jsxs("span", {
                            ...
                            children: [
                              Number(
                                dataResults.averageVotePerProvince.toFixed(2),
                              ),
                              "  votes / prov.",
                            ],
                          }),
        ...
        _jsx("div", {
          ...
          children: _jsxs("div", {
            ...
            children: [
                    ...
                    children: [
                      _jsxs("div", {
                        ...
                        children: [
                          _jsx("span", {
                            className: "font-inria-sans text-xl text-gray-400",
                            children: "Daily increment in vote",
                          }),
                          _jsx("span", {
                            className: "font-inria-sans text-sm text-gray-300",
                            children: "Last day x Today",
                          }),
                        ],
                      }),
                      _jsx("div", { children: _jsx(LineChartDemo, {}) }),
                    ],
                  }),
                  _jsxs("div", {
                    className: "col-span-3 bg-white rounded-xl pl-4 pr-4 pt-4",
                    children: [
                      _jsx("span", {
                        className: "font-inria-sans text-xl text-gray-400",
                        children: "Statistics",
              ...
              _jsxs("div", {
                className: "cols-span-3 flex-col rounded-xl p-4 mt-3 flex-1",
                children: [
                  _jsx("span", {
                    className: "font-inria-sans text-xl text-gray-400",
                    children: "Coverage Region",
                  }),
                  _jsx("div", {
                    className: "items-center justify-center",
                    children:
                      dataResults.votesPerProvince && _jsx(GoogleMap, {}),
                  }),
                ],
              }),
            ],
