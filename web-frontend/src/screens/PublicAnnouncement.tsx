      ...
      <AlertDialog>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will generate a speech based on
              the current election's result and be charged about $1. Please,
              double check your action!
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <div className="col-span-3 flex flex-col gap-5 md:flex-col ">
            <div className="flex flex-col md:gap-2 w-full bg-red gap-2 ">
              <div className="flex flex-row gap-2 py-1 sm:flex-row md:flex-row">
                ...
                <button
                  className={`max-w-lg inline-block text-md text-white px-4 py-2 rounded-md cursor-pointer ${
                    clicked
                      ? "animate-explode"
            ...
            <div className="grid grid-cols-2 h-full">
              <div className="flex flex-col gap-1 sm:gap-2 md:gap-3 lg:gap-4 items-center justify-center">
                <span className="font-inria-sans text-base sm:text-lg md:text-xl lg:text-2xl text-gray-500">
                  Progress
                </span>
                <span className="font-bold font-inria-sans text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-600">
                  {counter}%
                </span>
              </div>
              <div className="p-l">
